...
def cmd_create(args):
    ...
    created_by  = args.created_by or "orchestrator"
...
def main():
    ...
    p_create.add_argument("--created-by", dest="created_by", default="orchestrator",
                          help="Creator name/model (default: orchestrator)")
