...
- `Andy contract`: `scripts/model_supervisor.py` now states explicitly in its module/docs that the supervisor is a pure delegating orchestrator and does not perform worker specialist work itself.
